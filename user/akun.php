...
<h2>AKUN SAYA</h2>
    ...
    <div class="saya" style="margin-top: 20px;">
        <div class="aa">
		<form action="proses_update.php" method="post">
		<input type="hidden" name="id_user" value="<?php echo $data['id_user'];?>"readonly>
            <table>
                <tr>
                    <td class="satu">Username </td>
                    <td><input type="text" name="username" value="<?php echo $data['username'];?>"readonly></td>
                </tr>
                <tr>
                    <td class="dua">Email</td>
                    <td><input type="text"  name="email" required value="<?php echo $data['email'];?>"></td>
                </tr>
                <tr>
                    <td>No Telepon  </td>
                    <td><input type="text"  name="tlpn" required value="<?php echo $data['tlpn'];?>"></td>
                </tr>
                <tr>
                    <td>Jenis Kelamin</td>
                    <td><input type="text"  name="jenis_kelamin" required value="<?php echo $data['jenis_kelamin'];?>"></td>
                </tr>
                <tr>
                    <td>Tanggal Lahir</td>
                    <td><input type="text"  name="tgl_lahir" required value="<?php echo $data['tgl_lahir'];?>"></td>
                </tr>
               	<tr><td>  <input type="submit" value="SIMPAN" class="btn"></td></tr>
