			...
			<div class="header-cart-content flex-w js-pscroll">
				...
				<div class="w-full">
					...
					<div class="header-cart-buttons flex-w w-full">
						...
						<a href="checkut.php" class="flex-c-m stext-101 cl0 size-104 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
							Check Out
						</a>
					</div>
				</div>
						...
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<tr class="table_row">
									...
									<td class="column-2">Olivia Burton Big Quartz </td>
									<td class="column-3">Rp 358.000</td>
									<td class="column-4">
									...
									<td class="column-5">Rp 358.000</td>
								</tr>
								...
								<tr class="table_row">
									...
									<td class="column-2">	Olivia Burton Abstract Floral</td>
									<td class="column-3">Rp 539.000</td>
									<td class="column-4">
										<div class="wrap-num-product flex-w m-l-auto m-r-0">
											<div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m">
												<i class="fs-16 zmdi zmdi-minus"></i>
									...
									<td class="column-5">Rp 539.000</td>
								</tr>
								...
								<tr class="table_row">
									...
									<td class="column-2">	REBIRTH Wanita Display Kuarsa</td>
									<td class="column-3">Rp. 258.000</td>
									<td class="column-4">
										<div class="wrap-num-product flex-w m-l-auto m-r-0">
											<div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m">
												<i class="fs-16 zmdi zmdi-minus"></i>
									...
									<td class="column-5">Rp. 258.000</td>
								</tr>
					...
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						...
						<div class="flex-w flex-t bor12 p-t-15 p-b-30">
							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
								...
								<a href="checkut.php" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
									CheckOut
								</a>
